...
/**
 * Collection of helper methods to notify the system of changes in the section items.
 */
/* default */ interface SectionNotifier {

    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemInserted}.
     *
     ...
     * system and calls {@link Adapter#notifyItemRangeInserted}.
     */
    void notifyAllItemsInserted();

    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemRangeInserted}.
     *
    ...
    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemRemoved}.
     *
     * @param position position of the item in the section
     */
    ...
    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemRangeRemoved}.
     *
    ...
    /**
     * Helper method that calculates the relative header position in the system and calls
    ...
    /**
     * Helper method that calculates the relative footer position in the system and calls
     * {@link Adapter#notifyItemChanged}.
     */
    ...
    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemChanged}.
     *
     * @param position position of the item in the section
     */
    ...
    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemRangeChanged}.
     */
    ...
    /**
     * Helper method that receives position in relation to the section, calculates the relative
     * position in the system and calls {@link Adapter#notifyItemMoved}.
     *
     ...
     * view holder in the system. Useful to be called after changing the State from
     ...
     * the position of the {@link Section.State} view holder in the system. Useful to be called after
     ...
     * header in the system. Useful to be called after changing the visibility of the section's
    ...
    /**
     * Helper method that calls {@link Adapter#notifyItemInserted} with the position of the section's
     * footer in the system. Useful to be called after changing the visibility of the section's
     ...
     * in the system. Useful to be called after changing the visibility of the section to visible
    ...
    /**
     * Helper method that calls {@link Adapter#notifyItemRangeInserted} with the position of the section
     * in the system. Useful to be called after changing the visibility of the section to invisible
     * with {@link Section#setVisible}.
     *
